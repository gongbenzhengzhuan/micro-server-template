...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.template.micro.client.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("数据组件")  // 大标题
                .description("数据组件 API 接口文档") //描述
                .termsOfServiceUrl("http://localhost:8088/doc.html")  //网络服务地址。公司网址
